...
class BookController extends Controller
{
       ...
       // dd($request);
        if (
           ...
           // $create_book = Book::create($record);
            $create_book = DB::table('book')->insert([
                'name' => $request->name,
                'isbn' => $request->isbn,
    ...
    public function getBook()
    {
        ...
        if (empty($record_data)) {
            $data = "";
            $record = DB::table('book')->select('*')->get();
          //  $record = Book::all();
            $res = [];
    ...
    public function Update(Request $request, $id)
    {
        ...
        $update_book = DB::table('book')->where('id', $id)
            ->update([
                'name' => $request->name, 
                'isbn' => $request->isbn,
                'authors' => $request->authors,
    ...
    public function Delete($id)
    {
        ...
        if (empty($result[0])) {
            ...
            $book_deleted = DB::table('book')->where('id', $id)->delete();
          // var_dump($book_deleted);
            if (!$book_deleted) {
                $response = [
                    'status_code' => '404',
